          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">
                Servicii organizate, clare și rapide
              </h1>
              <p className="mt-4 max-w-xl text-base leading-7 text-white/85">
                Aplicăm spumă poliuretanică cu celulă deschisă sau închisă pentru izolare termică și etanșare. Te ajutăm să alegi soluția potrivită și să primești ofertă rapid.
              </p>

              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/calculator"
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-6 py-3 text-sm font-semibold text-slate-950 shadow-sm transition hover:bg-slate-100"
                >
                  Calculator de preț
                </Link>
                <Link
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/10 backdrop-blur-sm">
              <div className="text-sm font-semibold text-white">Avantaje</div>
              <div className="mt-4 grid gap-2 text-sm text-white/90">
                <div className="inline-flex items-center gap-2">
                  <CheckIcon className="h-5 w-5" /> Aplicare rapidă
                </div>
                <div className="inline-flex items-center gap-2">
                  <CheckIcon className="h-5 w-5" /> Etanșare fără rosturi
                </div>
                <div className="inline-flex items-center gap-2">
                  <CheckIcon className="h-5 w-5" /> Pierderi termice reduse
                </div>
                <div className="inline-flex items-center gap-2">
                  <CheckIcon className="h-5 w-5" /> Estimare transparentă
                </div>
              </div>
      ...
      <Container className="py-12">
        <div className="grid gap-10">
          <section className="grid gap-4 lg:grid-cols-3 lg:items-start">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900">Tipuri de spumă</h2>
            <div className="grid gap-4 lg:col-span-2 sm:grid-cols-2">
              <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-800">Celulă deschisă</div>
                <p className="mt-3 text-sm leading-6 text-slate-600">Recomandată pentru interior: mai moale, respiră, bună pentru confort termic și fonic.</p>
                <ul className="mt-4 grid gap-2 text-sm text-slate-700">
                  <li className="inline-flex items-center gap-2">
                    <CheckIcon className="h-5 w-5 text-emerald-600" /> Interior (pereți/planșeu)
                  </li>
                  <li className="inline-flex items-center gap-2">
                    <CheckIcon className="h-5 w-5 text-emerald-600" /> Izolare fonică bună
                  </li>
                </ul>
              </div>
              <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                <div className="inline-flex items-center gap-2 rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-800">Celulă închisă</div>
                <p className="mt-3 text-sm leading-6 text-slate-600">Densă și rigidă. Poate funcționa și ca hidroizolație și oferă rezistență structurală în anumite aplicații.</p>
                <ul className="mt-4 grid gap-2 text-sm text-slate-700">
                  <li className="inline-flex items-center gap-2">
                    <CheckIcon className="h-5 w-5 text-sky-600" /> Densă, rigidă
                  </li>
                  <li className="inline-flex items-center gap-2">
                    <CheckIcon className="h-5 w-5 text-sky-600" /> Barieră suplimentară la apă
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="grid gap-4 lg:grid-cols-3 lg:items-start">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900">Unde aplicăm</h2>
            <div className="grid gap-4 lg:col-span-2 sm:grid-cols-2">
              {[
                {
                ...
                <div key={x.title} className="rounded-[28px] border border-slate-200 bg-slate-50 p-6 shadow-sm">
          ...
          <section className="grid gap-4 lg:grid-cols-3 lg:items-start">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900">Proces simplu</h2>
            <div className="lg:col-span-2">
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={s.step} className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                    <div className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-r from-emerald-600 to-sky-600 text-sm font-semibold text-white">
                      {s.step}
                    </div>
                    <div className="mt-4 text-sm font-semibold text-slate-900">{s.title}</div>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-gradient-to-br from-emerald-50 via-white to-sky-50 p-7 shadow-sm">
            <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
              <div>
                <h2 className="text-2xl font-semibold tracking-tight text-slate-900">Vrei ofertă rapidă?</h2>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Trimite pe WhatsApp: suprafață (m²), grosime (cm), locație și 2–3 poze. Primești răspuns cât mai repede.
                </p>
              </div>
              <div className="grid gap-3 sm:grid-cols-3">
                <Link
                  href="/calculator"
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-sm hover:bg-slate-100"
                >
                  Calculator
                </Link>
                <Link
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm">
            <div className="grid gap-4 lg:grid-cols-3 lg:items-start">
              <div>
                <h2 className="text-2xl font-semibold tracking-tight text-slate-900">Zone acoperite</h2>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Lucrăm frecvent în zonele de mai jos și ne deplasăm și în alte județe, în funcție de proiect.
                </p>
              </div>
              <div className="lg:col-span-2">
