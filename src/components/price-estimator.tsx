...
export function PriceEstimator({ compact }: { compact?: boolean }) {
  ...
  return (
    <div
      className={[
        "rounded-[28px] border border-black/5 bg-white text-zinc-900 shadow-xl shadow-black/10",
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 sm:gap-3 sm:grid-cols-2">
        <button
          type="button"
      ...
      <div className="mt-4 grid grid-cols-1 gap-2 sm:gap-3 sm:grid-cols-2">
      ...
      <div className="mt-3 grid grid-cols-1 gap-2 sm:gap-3 sm:grid-cols-2">
        <label className="grid gap-2">
      ...
      <div className="mt-5 grid grid-cols-1 gap-2 sm:gap-3 sm:grid-cols-2">
        <Link
